...
export const WIPComponent = () => {
    ...
    const handleGoBack = () => {
        ...
        // Si prefieres mandarlo a la home siempre, cambia el -1 por "/"
        navigate(-1); 
    };
    ...
    return (
        <div 
            className="relative min-h-[100dvh] w-full flex items-center justify-center p-4 bg-primary-900 overflow-hidden"
            // Si quieres ponerle la imagen de fondo, descomenta la siguiente línea:
            // style={{ backgroundImage: `linear-gradient(rgba(10, 10, 10, 0.7), rgba(10, 10, 10, 0.7)), url(${bg})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
        >
            {/* Elementos decorativos de fondo (brillos sutiles) */}
