 ...
 *
 * This component renders an interactive line chart tracking the user's effectiveness
 * over a given time range. It supports dynamic filtering by metric (e.g., concentration,
 * profitability) and time granularity (e.g., daily, weekly) by injecting custom selection
 * tabs into the parent layout's header.
 *
 * @component
