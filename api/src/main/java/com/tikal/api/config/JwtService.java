...
public class JwtService {
    ...
    private String buildToken(final Map<String, Object> extraClaims, final User user, final long expiration) {
        return Jwts.builder()
    ...
    public boolean isTokenValid(final String token, final String userEmail) {
