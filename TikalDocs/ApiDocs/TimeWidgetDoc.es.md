...
* **No calcules la diferencia de fechas en el front**. Utiliza directamente el campo `durationInSeconds` y pásalo por tu función de formateo para pintar la pastilla de tiempo (ej. `"3h 5m"` o `"25m"`). Si no se llega a un minuto, se queda en en 0m el timeLog.
